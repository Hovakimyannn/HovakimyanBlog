...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="margin-top:5px;">
                <div class="image">
                    <img src="{{ asset('assets/admin/img/user2-160x160.jpeg') }}" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div style="
                  text-indent: 20px;
    ...
    <footer class="main-footer">
        ...
        Copyright &copy; 2021 <h3 style="color:purple"> Created by Hovakimyan</h3>. All rights reserved.
    </footer>
